...
const UseEffect = props => {
    ...
    useEffect( () => {
        console.log('eseEffecr: executa a cada Re-Renderização. \n\n')
    })

    useEffect( () => {
        console.log('useEffect consicional ao componente:')
        console.log('Executa somente a montagem do componente. \n\n')
    }, [])
    ...
    useEffect( () => {
        ...
        console.log('Executa enquanto um componente exister. \n\n')
